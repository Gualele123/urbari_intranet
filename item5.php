...
$sql = "SELECT c.id, c.foto, c.nombre, c.contacto, a.nombre AS area, col.nombre AS colaborador 
        FROM contactos c
...
<div class="row">
    ...
    <tr>
        ...
        <th>Interno</th>
        <th>Área</th>
        <th>Colaborador</th> <!-- Nueva columna -->
        <th>Acciones</th>
    </tr>
</thead>
<tbody>
    <?php foreach ($contacts as $contact): ?>
        <tr>
            ...
            <td><?= $contact['area']; ?></td>
            <td><?= $contact['colaborador']; ?></td> <!-- Nueva columna -->
            <td>
