...
<!-- como se crea la card con consulta -->
    <div class="card">
    	<img src="fotos/${empleado.id}.jpg" alt="">
    	<h2>${empleado.nombre} ${empleado.appaterno} ${empleado.apmaterno}</h2>
       	<p>Área: ${empleado.area}</p>
        <p>Semana del Año: ${empleado.semana_anio}</p>
        <p>Fecha de Nacimiento: ${dia}/${mes}</p>
    </div>
